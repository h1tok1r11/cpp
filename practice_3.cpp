...
void input_data_and_value() {
    cout << endl << "Введите место участника, перед которым будет располагаться ваша запись в таблице (целочисленное значение): "; cin >> ur_cnt;
    cout << "Введите новый элемент списка:" << endl << endl;
    cout << "Фамилия участника: "; cin >> new_item->data.surname;
    cout << "Код команды (один символ): "; cin >> new_item->data.code;
